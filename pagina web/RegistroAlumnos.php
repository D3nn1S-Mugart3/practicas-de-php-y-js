...
<body>
    ...
    <div class="container mt-4 color-text">
        <form action="RegistroAlumnos.php" method="post">
            <input type="number" name="NumeroAlumnos" placeholder="NO.Alumnos" class="form control">
        ...
        <form action="mostrar.php" method="post">
            ...
            if (isset($_POST['NumeroAlumnos'])) {
                for($alumno= 0; $alumno < $_POST['NumeroAlumnos']; $alumno++) {
                    ...
                    '<input placeholder="Escribe aqui tu apellido" type="text" name="apellido" class="form control mt-2">'.
                    '<input placeholder="Escribe aqui tu edad" type="number" name="edad" class="form control mt-2">';
